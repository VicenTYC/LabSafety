<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    <div id="frame" >
    	<div id="photos" class="play">
        	<img src="./Resource/images/lunbo1.jpg" width="1100px" height="180px">
        	<img src="./Resource/images/lunbo2.jpg" width="1100px" height="180px">
        	<img src="./Resource/images/lunbo3.jpg" width="1100px" height="180px">
        	<img src="./Resource/images/lunbo4.jpg" width="1100px" height="180px">       
    	</div>
	</div>