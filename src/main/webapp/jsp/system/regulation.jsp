            ...
            <table class="layui-table" lay-skin="line">
                ...
                <c:forEach items="${regulations}" var="regulation">
                    <tr>
                        ...
                        <td><fmt:formatDate
                                value="${regulation.file_date}" pattern="yyyy/MM/dd" /></td>
                        <td><button class="layui-btn layui-btn-sm layui-btn-normal">
                            <a href="deleteSystemNotice.do?noticeId=${regulation.file_id}"> <i class="layui-icon"></i> 删除</a>
                        </button></td>
                    </tr>
                </c:forEach>
                </tbody>
